...
const mena_coupon_firebase_adminsdk_json_1 = __importDefault(require("../mena-coupon-firebase-adminsdk.json"));
const verifyGoogleToken = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    // for google  app initialize
    if (!firebase_admin_1.default.apps.length) {
        firebase_admin_1.default.initializeApp({
            credential: firebase_admin_1.default.credential.cert(mena_coupon_firebase_adminsdk_json_1.default),
        });
    }
